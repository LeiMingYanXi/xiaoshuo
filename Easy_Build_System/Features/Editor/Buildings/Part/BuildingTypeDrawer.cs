...
namespace EasyBuildSystem.Editor.Runtime.Buildings.Part
{
    ...
    public class BuildingTypeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (BuildingType.Instance.BuildingTypes != null)
            {
                string[] allTypesToArray = BuildingType.Instance.BuildingTypes.ToArray();
